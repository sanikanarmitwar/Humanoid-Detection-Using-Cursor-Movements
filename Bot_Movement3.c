...
#define STEP_SIZE 20           // Number of pixels to move in each step

// Bot movement patterns: Right and Down
int directions[2][2] = {
    {1, 0},  // Right
    {0, 1}   // Down
};
...
int main() {
    Display *display;
    Window root;
    int x = 50, y = 50;  // Starting position for the cursor
    ...
    while (1) {
        ...
        // Every 5 steps, make a sharp 90-degree turn (Right -> Down -> Right...)
